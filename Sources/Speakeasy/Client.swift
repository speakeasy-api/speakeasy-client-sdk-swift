...
public final class Client {
    ...
    ) async throws -> Response<ResponseObject> {
        return try await withCheckedThrowingContinuation { continuation in
            _makeRequest(with: server, configureRequest: configureRequest) { result in
                do {
                    ...
                    continuation.resume(returning: Response<ResponseObject>(httpResponse: apiResponse.httpResponse, data: responseObject))
                    ...
                    case .failedToDecodeResponse:
                        continuation.resume(throwing: SpeakeasyError.failedToHandleResponse(.failedToDecodeResponse))
