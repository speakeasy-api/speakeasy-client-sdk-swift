...
///
/// ``SpeakeasyError`` describes problems which occur through the lifecycle of making a request to the API, from constructing the underlying network request, through making the network request and handling the resulting response.
///
/// Most of the error values have associated failure reasons:
/// - ``SpeakeasyError/failedToConstructRequestURL(_:)``
/// - ``SpeakeasyError/failedToSerializeRequestParameters(_:)``
/// - ``SpeakeasyError/failedToConstructRequest(_:)``
/// - ``SpeakeasyError/failedToHandleResponse(_:)``
///
/// which provide more information about why the error occurred.
///
/// If a network error occurs when making an API request, ``SpeakeasyError/failedToMakeNetworkRequest(error:)`` has an associated [`Error`](https://developer.apple.com/documentation/swift/error) value which describes more information about why the network error occurred.
///
/// In exceptional circumstances there may be an internal error which occurs in the implementation of ``Speakeasy`` or in the underlying system frameworks. Where this occurs, ``SpeakeasyError/internalError(error:)`` provides this information, with additional context if it is available.
///
/// ### Getting an error description
///
/// ``SpeakeasyError`` conforms to the [`LocalizedError`](https://developer.apple.com/documentation/foundation/localizederror) protocol. As such a readable description of the error is provided through the [`errorDescription`](https://developer.apple.com/documentation/foundation/localizederror/2946895-errordescription) property.
///
/// ## Topics
///
/// ### Errors
...
/// - ``SpeakeasyError/failedToSerializeRequestParameters(_:)``
/// - ``SpeakeasyError/failedToConstructRequest(_:)``
/// - ``SpeakeasyError/failedToMakeNetworkRequest(error:)``
/// - ``SpeakeasyError/failedToHandleResponse(_:)``
/// - ``SpeakeasyError/internalError(error:)``
///
/// ### Error failure information
/// - ``SpeakeasyError/RequestURLConstructionFailureReason``
/// - ``SpeakeasyError/ParameterSerializationFailureReason``
/// - ``SpeakeasyError/RequestConstructionFailureReason``
/// - ``SpeakeasyError/ResponseHandlingFailureReason``
///
/// ### Convenience properties
/// - ``SpeakeasyError/underlyingError``
public enum SpeakeasyError: Swift.Error {
    /// Failure reasons for ``SpeakeasyError/failedToConstructRequestURL(_:)`` errors
    ...
    /// Failure reasons for ``SpeakeasyError/failedToSerializeRequestParameters(_:)`` errors
    ...
    /// Failure reasons for ``SpeakeasyError/failedToConstructRequest(_:)`` errors
...
extension SpeakeasyError.RequestURLConstructionFailureReason {
...
extension SpeakeasyError.ParameterSerializationFailureReason {
    public var localizedDescription: String {
        switch self {
...
extension SpeakeasyError.RequestConstructionFailureReason {
    public var localizedDescription: String {
        switch self {
        case .missingRequiredRequestBody:
