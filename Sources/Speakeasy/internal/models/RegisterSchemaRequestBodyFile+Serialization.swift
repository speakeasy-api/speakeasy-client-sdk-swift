...
extension Operations.RegisterSchemaRequestBodyFile: Serializable {
    func serialize(with format: SerializableFormat) throws -> String {
        switch format {
        case .multipart:
            // Deep, non-JSON encoded multipart serialization is not supported.
            throw SerializationError.invalidSerializationParameter(type: "Operations.RegisterSchemaRequestBodyFile", format: format.formatDescription)
...
extension Operations.RegisterSchemaRequestBodyFile: MultipartFormBodySerializable {
